...
import CustomizationPanel from '../components/CustomizationPanel'; // ✅ Import the new panel component
...
const ResumeForm = () => {
    ...
    // ✅ Updated handler to work with nested state
